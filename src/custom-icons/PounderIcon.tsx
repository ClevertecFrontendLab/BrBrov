...
const PounderIcon: ComponentWithAs<'svg', IconProps> = createIcon({
    ...
    path: (
        ...
        >
            <rect width='24' height='24' fill='url(#pattern0_6002_19969)' />
            <defs>
                <pattern
                    id='pattern0_6002_19969'
                    patternContentUnits='objectBoundingBox'
                    width='1'
                    height='1'
                >
                    <use
                        xlinkHref='#image0_6002_19969'
                        transform='translate(0.166667 0.208333) scale(0.00694444)'
                    />
                </pattern>
                <image
                    id='image0_6002_19969'
                    width='96'
                    height='96'
