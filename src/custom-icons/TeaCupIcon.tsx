...
const TeaCupIcon: ComponentWithAs<'svg', IconProps> = createIcon({
    ...
    path: (
        ...
        >
            <rect width='24' height='24' fill='url(#pattern0_6002_19976)' />
            <defs>
                <pattern
                    id='pattern0_6002_19976'
                    patternContentUnits='objectBoundingBox'
                    width='1'
                    height='1'
                >
                    <use
                        xlinkHref='#image0_6002_19976'
                        transform='translate(0.125 0.144216) scale(0.0078125)'
                    />
                </pattern>
                <image
                    id='image0_6002_19976'
                    width='96'
                    height='96'
