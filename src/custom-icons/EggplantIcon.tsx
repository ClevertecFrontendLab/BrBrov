...
const EggplantIcon: ComponentWithAs<'svg', IconProps> = createIcon({
    ...
    path: (
        ...
        >
            <rect width='24' height='24' fill='url(#pattern0_6002_19473)' />
            <defs>
                <pattern
                    id='pattern0_6002_19473'
                    patternContentUnits='objectBoundingBox'
                    width='1'
                    height='1'
                >
                    <use
                        xlinkHref='#image0_6002_19473'
                        transform='translate(0.161085 0.153364) scale(0.00751704)'
                    />
                </pattern>
                <image
                    id='image0_6002_19473'
                    width='96'
                    height='96'
