...
const BreadAndRollingPinIcon: ComponentWithAs<'svg', IconProps> = createIcon({
    ...
    path: (
        ...
        >
            <rect width='24' height='24' fill='url(#pattern0_6002_19677)' />
            <defs>
                <pattern
                    id='pattern0_6002_19677'
                    patternContentUnits='objectBoundingBox'
                    width='1'
                    height='1'
                >
                    <use
                        xlinkHref='#image0_6002_19677'
                        transform='translate(0.125 0.125) scale(0.0078125)'
                    />
                </pattern>
                <image
                    id='image0_6002_19677'
                    width='96'
                    height='96'
