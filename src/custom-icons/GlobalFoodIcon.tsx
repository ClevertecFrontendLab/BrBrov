...
const GlobalFoodIcon: ComponentWithAs<'svg', IconProps> = createIcon({
    ...
    path: (
        ...
        >
            <rect width='24' height='24' fill='url(#pattern0_6002_19913)' />
            <defs>
                <pattern
                    id='pattern0_6002_19913'
                    patternContentUnits='objectBoundingBox'
                    width='1'
                    height='1'
                >
                    <use
                        xlinkHref='#image0_6002_19913'
                        transform='translate(0.166667 0.166667) scale(0.00694444)'
                    />
                </pattern>
                <image
                    id='image0_6002_19913'
                    width='96'
                    height='96'
